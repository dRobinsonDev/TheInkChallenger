...
class MyUser(AbstractUser):
    ...
    # artists = models.OneToManyField(Artist) # does a user belong to an artist? if appt gets canceled, do we still want an association to artist?
    # tattoos = models.OneToOneField(Tattoo) 
    # tattoo will belong to an appointment or vice versa, do we need both?
